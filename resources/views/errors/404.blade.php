  ...
  transform: translateY(800px)
    ...
    <div class="text">
      <div class="text-inner">
         <h1 style="font-family: 'Montserrat', sans-serif; font-weight: bold!important; font-size: 1rem;"> 404 , Désolé, La page que vous chercher n’est pas disponible actuellement.
        </h1>

        <h2>L'URL demandée n'a pas été trouvée sur ce serveur. C'est tout ce que nous savons.</h2>
        <a style="text-decoration: none;" href="/">
        <div id="home" class="button">
            <h3 style="cursor: pointer;"> Retourner </h3>
        </div>
    </a>
        </div>
